...
# def test_file_and_file_download():
#     # Create a temporary test directory
#     test_dir = "peer_5002_repository"

#     # Create a temporary test file
#     test_file_path = os.path.join(test_dir, "weather.csv")

#     # Initialize File class and validate metadata
#     file = File_upload(test_file_path)
#     metainfo = file.get_metainfo()

#     print("Metadata:", metainfo)
#     print("Total Hash:", file.total_hash)
#     print("Bitfield (initial):", file.get_bitfield())
#     print("Piece 0 Hash:", file.get_piece_with_index(0).hash)

#     # Initialize File_download class
#     file_download = File_download(num_piece=metainfo["num_pieces"])

#     # Simulate downloading pieces
#     for piece in file.pieces:
#         file_download.add_piece(piece.data, piece.index)

#     print("Bitfield (downloaded):", file_download.piece_idx_downloaded)

#     file_download.save_complete_file("peer_5001_repository", "weather.csv")


# if __name__ == "__main__":
#     test_file_and_file_download()
